...
import com.osrs.game.model.logs.HandleLogs;
...
public class CommandPacketListener implements PacketListener {
	...
	public static boolean executeCommand(Player c, String playerCommand, String commandPackage) {
		...
		try {
			String path = "com.osrs.net.packet.impl.commands." + commandPackage + "." + className;
	...
	public static void initializeCommands() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		String[] packages = {
				"com.osrs.net.packet.impl.commands.all",
				"com.osrs.net.packet.impl.commands.donator",
				"com.osrs.net.packet.impl.commands.support",
				"com.osrs.net.packet.impl.commands.moderator",
				"com.osrs.net.packet.impl.commands.admin",
				"com.osrs.net.packet.impl.commands.developer",
				"com.osrs.net.packet.impl.commands.owner"
		};
