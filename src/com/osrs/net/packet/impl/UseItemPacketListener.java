...
import com.osrs.game.content.interactable.ZulrahItems;
import com.osrs.game.content.interactable.ZulrahItems.ZulrahItemType;
import com.osrs.game.content.minigames.warriors_guild.AnimatedArmour;
import com.osrs.game.content.skill.cooking.Cookable;
import com.osrs.game.content.skill.cooking.Cooking;
import com.osrs.game.content.skill.cooking.Pie;
import com.osrs.game.content.skill.cooking.Cookable.Fish;
import com.osrs.game.content.skill.cooking.Cookable.Pizza;
import com.osrs.game.content.skill.crafting.Crafting;
import com.osrs.game.content.skill.crafting.LeatherMaking;
import com.osrs.game.content.skill.farming.Compost;
import com.osrs.game.content.skill.farming.Farming;
import com.osrs.game.content.skill.fletching.Fletching;
import com.osrs.game.content.skill.herblore.Herblore;
import com.osrs.game.content.skill.herblore.UnfCreator;
import com.osrs.game.content.skill.prayer.BoneData;
import com.osrs.game.content.skill.prayer.Prayer.AltarOffering;
import com.osrs.game.content.skill.skillable.impl.Firemaking;
import com.osrs.game.content.skill.skillable.impl.Firemaking.LightableLog;
import com.osrs.game.content.skill.smithing.Smithing;
import com.osrs.game.entity.Entity;
import com.osrs.game.entity.impl.grounditem.ItemOnGround;
...
import com.osrs.game.entity.impl.object.MapObjects;
...
import com.osrs.game.model.menu.CreationMenu.CreationMenuAction;
...
import com.osrs.util.ObjectIdentifiers;
...
//        FarmingService.onGameObjectActionEvent(player,object, "item", item);
        ...
        switch (object.get().getId()) {
			...
			case ObjectIdentifiers.COOKING_RANGE_6:
                ...
                if (cookable != null) {
					if (cookable.isPie()) {
	            		com.osrs.game.content.skill.cooking.Cookable.Pie pie = cookable.getAsPie();
	            		if (pie != null) {
		                    CreationMenu cookMenu = new SingleItemCreationMenu(player, ((com.osrs.game.content.skill.cooking.Cookable.Pie) cookable.get()).getResult().getId(), "How many would you like to cook?", new CreationMenuAction() {
		                        @Override
		                        public void execute(int item, int amount) {
