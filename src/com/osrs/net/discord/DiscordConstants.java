...
public class DiscordConstants {
	...
	public static final String DISCORD_BOT_MESSAGE = "osrs | type ::help";
	...
	public static final String[] PERMS = {"osrs Member", "Server Support", "Moderator", "Forum Developer", "Graphics Designer"};
