...
import com.osrs.game.content.RottenPotato;
import com.osrs.game.content.bosses.zulrah.Zulrah;
...
public class DialogueHandler {
    ...
    public static boolean startDialogue(Player c, NPC npc) {
        ...
        String path = "com.osrs.game.content.dialogues.impl.npc." + className;
        ...
        try {
            ...
            try {
                DIALOGUE_MAP.get("com.osrs.game.content.dialogues.impl.npc.D_0").execute(c, npc);
            } catch (Exception e1) {
    ...
    public static void initialiseDialogues() throws IOException {
        ...
        String[] packages = {
                "com.osrs.game.content.dialogues.impl.npc"
        };
