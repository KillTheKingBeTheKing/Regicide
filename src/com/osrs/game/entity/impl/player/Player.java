package com.osrs.game.entity.impl.player;
...
import com.osrs.game.content.*;
import com.osrs.game.content.PrayerHandler.PrayerData;
import com.osrs.game.content.achievement.AchievementManager;
import com.osrs.game.content.achievement.DiaryManager;
import com.osrs.game.content.achievement.Diary.DiaryType;
import com.osrs.game.content.achievement.Diary.OptionType;
import com.osrs.game.content.achievement.Diary.Tasks;
import com.osrs.game.content.bosses.vorkath.VorkathLostItems;
import com.osrs.game.content.bosses.zulrah.ZulrahLostItems;
import com.osrs.game.content.clan.ClanChat;
...
import com.osrs.game.content.combat.magic.Autocasting;
import com.osrs.game.content.combat.method.impl.npcs.CerberusCombatMethod;
import com.osrs.game.content.combat.method.impl.npcs.VorkathCombatMethod;
import com.osrs.game.content.combat.method.impl.npcs.ZulrahCombatMethod;
import com.osrs.game.content.minigames.Minigame;
import com.osrs.game.content.minigames.MinigameAttributes;
import com.osrs.game.content.minigames.PointsHandler;
import com.osrs.game.content.minigames.barrows.Barrows;
import com.osrs.game.content.minigames.barrows.Barrows.Brother;
import com.osrs.game.content.minigames.fightcave.FightCaves;
import com.osrs.game.content.minigames.godwars.Godwars;
import com.osrs.game.content.minigames.nightmarezone.NightmareZone;
...
import com.osrs.game.content.skill.construction.House;
import com.osrs.game.content.skill.farming.Compost;
import com.osrs.game.content.skill.farming.Farming;
import com.osrs.game.content.skill.farming.Allotments.AllotmentFieldsData;
import com.osrs.game.content.skill.hunter.Hunter;
import com.osrs.game.content.skill.runecrafting.Runecrafting.Pouch;
import com.osrs.game.content.skill.runecrafting.Runecrafting.PouchContainer;
import com.osrs.game.content.skill.skillable.Skillable;
import com.osrs.game.content.skill.slayer.Slayer;
...
import com.osrs.game.model.container.impl.Equipment;
import com.osrs.game.model.container.impl.Inventory;
import com.osrs.game.model.container.impl.PriceChecker;
import com.osrs.game.model.container.shop.Shop;
import com.osrs.game.model.dialogue.Dialogue;
import com.osrs.game.model.dialogue.DialogueOptions;
import com.osrs.game.model.equipment.BonusManager;
import com.osrs.game.model.menu.CreationMenu;
import com.osrs.game.model.movement.MovementQueue;
import com.osrs.game.model.movement.WalkToAction;
import com.osrs.game.model.rights.Right;
import com.osrs.game.model.rights.RightGroup;
import com.osrs.game.model.syntax.EnterSyntax;
import com.osrs.game.model.teleportation.TeleportButton;
import com.osrs.game.task.Task;
import com.osrs.game.task.TaskManager;
import com.osrs.game.task.impl.CombatPoisonEffect;
import com.osrs.game.task.impl.PlayerDeathTask;
import com.osrs.game.task.impl.RestoreSpecialAttackTask;
import com.osrs.net.PlayerSession;
import com.osrs.net.channel.ChannelEventHandler;
import com.osrs.net.packet.PacketSender;
import com.osrs.util.FrameUpdater;
import com.osrs.util.Misc;
import com.osrs.util.NpcIdentifiers;
import com.osrs.util.Stopwatch;
...
public class Player extends Character {
	...
	public void onLogin() {
		...
		getPacketSender().sendMessage("Welcome " + rightsIcon + "" + modeIcon + " " + getMode().getYellPrefix() + getUsername() + "</col></shad>" + " to osrs!");
